...
export default function Header({ showDocs, setShowDocs }: HeaderProps) {
            ...
            <div className="flex flex-col md:flex-row items-center justify-between gap-4">
                ...
                <div className="flex gap-4">
                    <button
                        ...
                        className={`btn-secondary text-sm px-4 py-2 ${showDocs ? 'bg-black text-white' : ''}`}
                    >
                        {showDocs ? '← Back to Generator' : '📖 Read Docs'}
                    </button>
