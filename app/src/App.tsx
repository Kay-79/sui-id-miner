...
function App() {
    ...
    const isConfigValid = mode === 'PACKAGE'
        ...
        : mode === 'GAS_COIN'
            ...
            : isValidPrefix && txBytesBase64 && targetIndex >= 0
        ...
        if (mode === 'MOVE_CALL') {
            ...
            if (!bytes && mcTarget) {
                try {
                    ...
                    // Update state to show generated bytes? Maybe not needed.
                } catch (e: any) {
        ...
        <div className="min-h-screen p-4 md:p-8 bg-[var(--light)]">
            ...
            <div className="max-w-4xl mx-auto grid gap-6">
                ...
                <ConfigCard
                    ...
                    setTxBytesBase64={setTxBytesBase64}
